					...
					<ul id="exodus-sermon-full-buttons" class="exodus-list-buttons">
						...
						if ( $video_download_url ) :
							?><li id="exodus-sermon-full-video-download-button">
								<a href="<?php echo esc_url( $video_download_url ); ?>" title="<?php echo esc_attr( __( 'Download Video', 'exodus' ) ); ?>">
						...
						if ( $audio_download_url ) :
							?><li id="exodus-sermon-full-audio-download-button">
								<a href="<?php echo esc_url( $audio_download_url ); ?>" title="<?php echo esc_attr( __( 'Download Audio', 'exodus' ) ); ?>">
