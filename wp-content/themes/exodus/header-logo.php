			...
			<div id="exodus-logo-text" class="exodus-logo-text-<?php echo esc_attr( ctfw_customization( 'logo_text_size' ) ); ?>">
				<div id="exodus-logo-text-inner">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<?php echo nl2br( esc_html( wptexturize( force_balance_tags( ctfw_customization( 'logo_text' ) ) ) ) ); // "Church <span>Name</span>"" can be used for gray portion, so force balance tags ?>
					</a>
				</div>
			</div>
