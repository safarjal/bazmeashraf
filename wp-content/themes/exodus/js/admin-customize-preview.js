...
jQuery( document ).ready( function( $ ) {
	...
	wp.customize( exodus_customize_preview.option_id + '[main_color]', function( value ) {
		...
		value.bind( function( to ) {
			...
			selectors = exodus_customize_preview[ 'main_color_selectors' ];

			// Using second method with !important so slider controls work
			//$( selectors ).css( 'background-color', to );
			$( 'head' ).append( '<style type="text/css">' + selectors + ' { background-color: ' + to + ' !important; }</style>' );
