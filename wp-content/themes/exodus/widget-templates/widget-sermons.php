					...
					<li class="exodus-widget-entry-icons exodus-sermons-widget-entry-icons">
						...
						<ul class="exodus-list-icons">
							...
							<?php if ( $pdf_download_url ) : ?>
								<li><a href="<?php echo esc_url( $pdf_download_url ); ?>" class="<?php exodus_icon_class( 'pdf-download' ); ?>" title="<?php echo esc_attr( _x( 'Download PDF', 'sermons widget', 'exodus' ) ); ?>"></a></li>
							<?php endif; ?>
...
if ( empty( $posts ) ) {
	...
	?>
	<div>
		<?php _ex( 'There are no sermons to show.', 'sermons widget', 'exodus' ); ?>
	</div>
	<?php
