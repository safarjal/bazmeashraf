...
if ( ctfw_customization( 'show_footer_location' ) && ! empty( $location['ID'] ) ) {
	...
	$location_count = $location_counts->publish;
							...
							?>
								...
								<?php if ( $has_map ) : ?>
									...
									<div id="exodus-footer-top-map">
										...
										<a href="<?php echo esc_url( get_permalink( $location['ID'] ) ); ?>" title="<?php the_title_attribute(); ?>"><?php echo $img_tag; ?></a>
