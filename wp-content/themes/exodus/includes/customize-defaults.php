...
function exodus_customize_defaults() {
	...
	$defaults = array(
		...
		'footer_notice' => array(
			...
			'value'		=> __( '&copy; [ctcom_current_year] [ctcom_site_name]. Powered by <a href="http://churchthemes.com" target="_blank" rel="nofollow">churchthemes.com</a>.', 'exodus' ),
			'no_empty'	=> false
		),
