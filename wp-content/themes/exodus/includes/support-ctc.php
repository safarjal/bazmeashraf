 ...
 *
 * See developer guide: http://churchthemes.com/guides/developer/church-theme-content/
 *
 * @package    Exodus
	...
	add_theme_support( 'ctc-people', array(
		...
		'field_overrides' => array(
			...
			'_ctc_person_email' => array(
				'desc' => sprintf( __( 'The WordPress <a href="%s" target="_blank">antispambot</a> function is used to help deter automated email harvesting.', 'exodus' ), 'http://codex.wordpress.org/Function_Reference/antispambot' ),
			),
		),
	) );
