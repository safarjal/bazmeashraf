...
function exodus_customize_top_right_choices() {
	...
	$choices = array(
		...
		'sermons'	=> _x( 'Latest Sermons', 'customizer', 'exodus' ),
...
function exodus_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( $section, array(
		'title'		=> _x( 'Logo & Tagline', 'customizer', 'exodus' ),
		'priority'	=> $section_priority += $section_increment, // section order
	) );
	$control_priority = 0;
	...
	$section = 'static_front_page'; // default section
	$wp_customize->get_section( $section )->priority = $section_priority += $section_increment; // section order
	$control_priority = 0;
...
function exodus_customize_enqueue_scripts() {
	...
	wp_enqueue_script( 'exodus-admin-customize', ctfw_theme_url( CTFW_THEME_JS_DIR . '/admin-customize.js' ), array( 'jquery' ), CTFW_THEME_VERSION ); // bust cache on theme update
...
function exodus_customize_enqueue_styles() {
	...
	wp_enqueue_style( 'exodus-admin-customize', ctfw_theme_url( CTFW_THEME_CSS_DIR . '/admin-customize.css' ), false, CTFW_THEME_VERSION ); // bust cache on update
...
function exodus_customize_preview_enqueue_scripts() {
	...
	wp_enqueue_script( 'exodus-admin-customize-preview', ctfw_theme_url( CTFW_THEME_JS_DIR . '/admin-customize-preview.js' ), false, CTFW_THEME_VERSION ); // bust cache on theme update
